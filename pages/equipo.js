      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white text-center">
        <div className="container mx-auto px-6">
          ...
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto animate-fade-in-up">
            Somos Jairo y Shantall, los fundadores de PublicAdis. Unidos por una visión y pasión
            inquebrantable por el futuro de los negocios locales.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              La fuerza motriz de PublicAdis: una combinación de visión tecnológica y maestría en
              comunicación, dedicados a construir el futuro de la publicidad.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-stretch">
            {founders.map(member => (
              ...
              >
                <div
                  className={`h-80 md:h-96 w-full bg-gradient-to-br ${member.bgColor} relative overflow-hidden`}
                >
                  <Image
                    src={member.image}
                    alt={member.name}
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <p
                    className={`text-lg font-semibold mb-4 ${
                      member.name.includes('Jairo') ? 'text-purple-600' : 'text-pink-600'
                    }`}
                  >
                    {member.role}
                  </p>
                  <p className="text-gray-700 leading-relaxed mb-6 text-md flex-grow">
                    {member.bio}
                  </p>
                    ...
                    {Object.entries(member.socialLinks).length > 0 && (
                      <div className="flex space-x-4 justify-center flex-wrap">
                        {Object.entries(member.socialLinks).map(
                          ([key, link]) =>
                            link &&
                            icons[key] && ( // Verifica que el link y el icono existan
                              <a
                                key={key}
                                href={link}
                                target="_blank"
      ...
      <section className="py-16 lg:py-24 bg-gray-100">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold text-gray-800 mb-6">
            Forjando el Futuro:{' '}
            <span className="text-purple-600">Buscamos Constructores de Sueños</span>
          </h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-8">
            PublicAdis está en una trayectoria de crecimiento exponencial, y el corazón de nuestra
            expansión será un equipo de individuos extraordinarios. Aunque hoy somos un núcleo
            fundador ágil, estamos sentando las bases para atraer al talento más brillante y
            apasionado de Latinoamérica.
          </p>
          <div className="max-w-4xl mx-auto text-left space-y-6 mb-12">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 text-lg">
              <li>
                <span className="font-semibold text-pink-500">Innovadores Audaces:</span>{' '}
                Desarrolladores, ingenieros de IA, y tecnólogos que no teman desafiar lo
                convencional y construir soluciones que marquen la diferencia.
              </li>
              <li>
                <span className="font-semibold text-pink-500">Estrategas de Crecimiento:</span>{' '}
                Expertos en marketing digital, data scientists y especialistas en ventas que vivan
                para generar resultados medibles y exponenciales.
              </li>
              <li>
                <span className="font-semibold text-pink-500">Creadores de Conexiones:</span>{' '}
                Comunicadores, diseñadores y especialistas en experiencia del cliente que sepan cómo
                construir marcas amadas y comunidades comprometidas.
              </li>
              <li>
                <span className="font-semibold text-pink-500">Líderes con Propósito:</span>{' '}
                Individuos con una mentalidad de excelencia, que busquen no solo un trabajo, sino
                una misión para transformar nuestra región.
              </li>
            </ul>
            <h3 className="text-2xl font-semibold text-gray-800 mt-8">
              Nuestra Promesa Como Equipo:
            </h3>
            <p className="text-lg text-gray-700">
              En PublicAdis, aspiramos a construir una cultura donde la{' '}
              <span className="font-semibold">excelencia</span> sea la norma, la{' '}
              <span className="font-semibold">innovación</span> una práctica diaria, y el{' '}
              <span className="font-semibold">crecimiento</span> (personal y profesional) una
              garantía. Ofreceremos la oportunidad de:
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 text-lg">
              ...
              <li>
                Aprender y crecer junto a un equipo de alto rendimiento en un ambiente colaborativo
                y dinámico.
              </li>
          ...
          <p className="text-md text-gray-600 mt-6 max-w-2xl mx-auto">
            Pronto abriremos nuestras puertas a nuevos talentos. Si resuenas con nuestra visión y
            quieres ser parte de la próxima gran revolución publicitaria, ¡queremos saber de ti!
          </p>
        </div>
      </section>
    </Layout>
